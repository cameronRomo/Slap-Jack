...
### Wins
* Use of BEM naming conventions
* Solidified understanding of OOP
* Use of localStorage
* Implementation of JavaScript Fundamentals

### Challenges
* Knowing when and where to instantiate new instances of player and game Classes
* Committing code frequently
* Sending game data into localStorage
